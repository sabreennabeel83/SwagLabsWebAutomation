...
public class SelectedItemPageTests extends BaseTests {
...
@Test(priority = 3)
    public void testSelectedItems(){
        ...
        var selectedItemPage =homePage.selectedItem(item);
        selectedItemPage.addToCart();
        HomePage homePage1 =selectedItemPage.clickBackToProductsButton();
        var selectedOptions = selectedItemPage.getNumberOfItemsInCart();
